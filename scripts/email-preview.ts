...
const mockEvents: EventRow[] = [
  {
    ...
    is_manually_added: 0, is_published: 1, is_heads_up: 0, llm_score: 85,
  ...
  },
  {
    ...
    is_manually_added: 0, is_published: 1, is_heads_up: 0, llm_score: 90,
  ...
  },
  {
    ...
    is_manually_added: 0, is_published: 1, is_heads_up: 0, llm_score: 88,
...
const mockHeadsUp: EventRow[] = [
  {
    ...
    is_manually_added: 1, is_published: 1, is_heads_up: 1, llm_score: 95,
