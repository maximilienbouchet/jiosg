...
Validation additionally hard-trims the response: max 3 picks per source and max 3 `screen time` events, dropped lowest-rank first (the deterministic fill replaces them at display time).
